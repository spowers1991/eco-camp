...
const Button = ({ href, color, children, className, newTab }) => {    
    ...
    return (
        href && 
            <Link href={resolveLink(href)} target={newTab === true ? '_blank' : null} className={`${className} flex items-center gap-x-3 ${bgColor} font-bebas-neue duration-150 pb-[9px] pt-[12px] px-5 uppercase text-lg sm:text-xl font-[500] !tracking-wider leading-[1]`}>
